...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('images/holding.png')}}" type="image/x-icon">
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark bg-gradient shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{asset('images/holding.png')}}" alt="DS" class="img-responsive" width=35"> <strong>DS GROUP</strong>
                </a>
