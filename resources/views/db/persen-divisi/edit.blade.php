    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editInvestorTitle">Edit Komisaris @isset($d) {{$d->nama}} @endisset</h5>
                    ...
                    <div class="row">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" name="komisaris_id" id="edit_komisaris_id" required>
