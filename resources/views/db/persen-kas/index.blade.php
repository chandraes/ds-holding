...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 text-center">
            <h1><u>PERSENTASE PEMBAGIAN KAS</u></h1>
        </div>
    </div>
    ...
    <table class="table table-bordered table-hover" id="data">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center align-middle">{{strtoupper($d->nama)}}</td>
...
<script>
    ...
    function editRekening(data, id) {
        document.getElementById('edit_nama').value = data.nama.toUpperCase();
        document.getElementById('edit_persen').value = data.persen;
        document.getElementById('editForm').action = '/db/persen-kas/' + id + '/update';
    };
