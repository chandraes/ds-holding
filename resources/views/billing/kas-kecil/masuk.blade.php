...
<div class="container">
    ...
    @include('swal')
    <form action="{{route('kas-kecil.masuk.store')}}" method="post" id="masukForm">
        @csrf
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="input-group mb-3">
                    ...
                    is-invalid
                @endif" name="nominal_transaksi" id="nominal_transaksi" disabled data-thousands="." value="1.000.000">
                  </div>
